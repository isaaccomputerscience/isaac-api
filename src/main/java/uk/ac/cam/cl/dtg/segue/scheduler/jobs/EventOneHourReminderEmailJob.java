...
public class EventOneHourReminderEmailJob implements Job {
  private static final Logger log = LoggerFactory.getLogger(EventOneHourReminderEmailJob.class);
   ...
   */
  public EventOneHourReminderEmailJob() {
  ...
  public void execute(final JobExecutionContext context) throws JobExecutionException {
    scheduledEmailManager.sendOneHourReminderEmails();
    log.info("Ran EventOneHourReminderEmailJob");
  }
}
