...
public class IsaacSymbolicValidator implements IValidator {
    ...
    private ValidationResult checkForSymbolicAnswerMatch(final IsaacSymbolicQuestion question, final Formula submittedFormula)
            throws ValidatorUnavailableException {
    ...
    private static ValidationResult checkForExactAnswerMatch(final IsaacSymbolicQuestion question, final Formula submittedFormula) {
        // For all the choices on this question...
    ...
    private static void validateQuestionType(final Question question, final Choice answer) throws IllegalArgumentException {
