...
public class ItemOrikaConverter extends AbstractPolymorphicBidirectionalConverter<Item, ItemDTO> {
    ...
    @Override
    public ItemDTO convertTo(final Item source, final Type<ItemDTO> destinationType, final MappingContext _context) {
        if (null == source) {
            return null;
        }
    ...
    @Override
    public Item convertFrom(final ItemDTO source, final Type<Item> destinationType, final MappingContext _context) {
        if (null == source) {
            return null;
        }
