...
public interface IAssignmentPersistenceManager {
   ...
   * @throws SegueDatabaseException - if there is a problem saving the assignment in the database.
   */
   ...
   *
   * @param assignmentId - the id to search for.
   ...
   *
   * @param assignmentOwnerId - to search for
   * @param groupId           - to search for
   * @return assignments as a list
   * @throws SegueDatabaseException - if there is an error when accessing the database.
   */
   ...
   *
   * @param groupIds - the group Ids to collect all assignments for.
   * @return list of assignments
   * @throws SegueDatabaseException - if there is an error when accessing the database.
   */
   ...
   *
   * @param timestamp - the hour in which to look for scheduled assignments.
   * @return list of assignments
   * @throws SegueDatabaseException - if there is an error when accessing the database.
   */
