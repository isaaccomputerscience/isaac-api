...
public class UserAlertsWebSocket implements IAlertListener {
  ...
  private static final ObjectMapper objectMapper = getBasicObjectMapper();
   ...
   *
   * @param session - contains information about the currently connected session
   * @param message - text-based message from client
   */
  @OnWebSocketMessage
   ...
   *
   * @param session *          - contains information on the currently connected session
   * @param status  - the status of the connection
   * @param reason  - states the cause for closing the connection
   */
  @OnWebSocketClose
   ...
   *
   * @param session - contains information on the currently connected session, if any
   ...
   *
   * @param alert - user alert instance containing details about the event
   */
