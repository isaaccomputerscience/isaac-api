...
public class IsaacController extends AbstractIsaacFacade {
   ...
   * @param statsManager             - Instance of the Statistics Manager.
   * @param contentManager           - so we can find out the latest content version.
   * @param userManager              - So we can interrogate the user Manager.
   * @param associationManager       - So we can check user permissions.
   * @param contentIndex             - To get hash code for ETag calculation
   * @param userStreaksManager       - To get and set user streaks
   * @param userBadgeManager         - To get user badges
   ...
   * @param types              - a comma separated list of types to include in the search.
   ...
   *
   * @param request            - used for intelligent cache responses.
   * @param httpServletRequest - used for the Referer header for helpful error messages.
   * @param path               of image in the database
   ...
   * @param request            - used for intelligent cache responses.
   * @param httpServletRequest - used for the Referer header for helpful error messages.
   * @param path               - file path of document in the content database
