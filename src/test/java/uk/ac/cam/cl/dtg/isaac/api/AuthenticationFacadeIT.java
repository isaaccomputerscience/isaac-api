...
public class AuthenticationFacadeIT extends IsaacIntegrationTest {
    ...
    class AuthenticateWithCredentialsLocalProvider {
        ...
        @Test
        public void rateThrottleByIP() throws InvalidKeySpecException, NoSuchAlgorithmException, SegueResourceMisuseException {
            LocalAuthDTO testLocalAuthDTO = new LocalAuthDTO();
            testLocalAuthDTO.setEmail(TEST_UNKNOWN_USER_ONE_EMAIL);
            testLocalAuthDTO.setPassword(TEST_WRONG_PASSWORD);
        ...
        @Test
        public void rateThrottleByEmail() throws InvalidKeySpecException, NoSuchAlgorithmException, SegueResourceMisuseException {
            LocalAuthDTO testLocalAuthDTO = new LocalAuthDTO();
            testLocalAuthDTO.setEmail(TEST_STUDENT_EMAIL);
            testLocalAuthDTO.setPassword(TEST_STUDENT_PASSWORD);
    ...
    public void authenticateWithCredentialsLocalProviderInvalidAuthDTO(final String email, final String password) throws InvalidKeySpecException, NoSuchAlgorithmException {
        LocalAuthDTO testLocalAuthDTO = new LocalAuthDTO();
