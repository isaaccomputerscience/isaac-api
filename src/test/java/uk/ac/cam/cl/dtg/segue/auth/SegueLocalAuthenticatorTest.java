...
public class SegueLocalAuthenticatorTest {
	...
	class SegueLocalAuthenticatorSetOrChangeUsersPassword {
		 ...
		 */
		@Test
		public final void validPasswordPasswordAndHashShouldBePopulatedAsBase64() throws InvalidKeySpecException, NoSuchAlgorithmException {
			RegisteredUser someUser = new RegisteredUser();
			someUser.setEmail(TEST_USER_EMAIL);
			someUser.setId(TEST_USER_ID);
			replay(userDataManager);
	...
	class SegueLocalAuthenticatorAuthenticate {
		...
		public final void correctEmailAndIncorrectPasswordProvided()
			...
			assertThrows(IncorrectCredentialsProvidedException.class, () -> segueAuthenticator.authenticate(usersEmailAddress, TEST_USER_INCORRECT_PASSWORD));
		}
		...
		public final void badEmailAndIncorrectPasswordProvided()
			...
			assertThrows(IncorrectCredentialsProvidedException.class, () -> segueAuthenticator.authenticate(someBadEmail, TEST_USER_INCORRECT_PASSWORD));
		}
